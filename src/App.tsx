import {data} from "./data/dataset_part_one";
...
type AnswerType = "Si" | "No" | "Non sono sicuro";
...
const col = collection(firstore, "annotations_part_one") as CollectionReference<DataType>;
    ...
    const next = async (newAnswers: AnswerType[]) => {
        if (!isLoading) {
            ...
            if (dataset && i < dataset.length) {
                ...
                const docRef = doc(firstore, "annotations_part_one/" + name);
        ...
        !ready ?
            ...
            : <div>
                <div className="text-center justify-center mt-12">
                    {<MadeByMe/>}
                    <h1 className="text-4xl font-bold">Valutazione prima parte</h1>
